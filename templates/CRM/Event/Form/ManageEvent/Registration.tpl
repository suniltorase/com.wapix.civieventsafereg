...
<table class="form-layout-compressed">
  ...
  {/if}
  <tr class="crm-event-manage-registration-form-block-is_allow_registrations">
    <td scope="row" class="label" width="20%">{$form.is_allow_registrations.label}</td>
    <td>{$form.is_allow_registrations.html}</td>
  </tr>
